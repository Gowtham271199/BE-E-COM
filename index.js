...
app.use(cors())
//Database connection
mongoose.connect("mongodb+srv://gothammelo27:Hawk789$@cluster0.nbe9rxj.mongodb.net/e-commerce",{
...
//api creation
app.get("/",(req,res)=>{
    res.send("Express app is ruuning ")
})
...
//Creating endpoit for registering user
...
app.post('/addtocart',fetchUser,async(req,res)=>{
    console.log('Adding from cart...',req.body.itemId);
